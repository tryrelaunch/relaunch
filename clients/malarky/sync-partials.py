...
Run this from the malarky/ directory before every git push.
...
SKIP_DIRS = {'css', 'js', 'images', 'SEO-BRIEFS', '_partials', 'edit', 'fonts', '__pycache__'}
...
def find_pages():
    """Return sorted list of every index.html under malarky/."""
    pages = []
